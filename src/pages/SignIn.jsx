    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex items-center justify-center px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          <div className="mx-auto h-20 w-20 flex items-center justify-center bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl shadow-lg mb-6">
            <Shield className="h-10 w-10 text-white" />
          </div>
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Sentinel Health</h1>
          <p className="text-gray-600 text-sm">Your comprehensive health tracking companion</p>
        </div>
        ...
        <div className="text-center text-xs text-gray-500">
          <p>EOF v1 | Secure health data management</p>
        </div>
      </div>
    </div>
  );
...
export default SentinelHealthSignIn;