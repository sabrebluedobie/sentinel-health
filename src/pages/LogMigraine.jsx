...
const TRIGGERS = [
  ...
  "dehydration","bright_lights","strong_smells","physical_exertion","alcohol"
];
      ...
      <form onSubmit={onSubmit} className="space-y-4 border rounded-lg p-4 mx-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <label className="flex items-center gap-2">
            <input
              type="checkbox"
              checked={form.medication_effective}
          ...
          <label className="flex flex-col gap-1">
            ...
            <input
              ...
              step="0.1"
              className="border rounded p-2"
              value={form.barometric_pressure}
          ...
          <label className="flex flex-col gap-1 md:col-span-2">
            ...
            <input
              ...
              placeholder="Home, office, outdoors…"
            />
          </label>
