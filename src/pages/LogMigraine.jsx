...
export default function LogMigraine() {
  ...
  async function submit(e) {
    ...
    if (!Number.isFinite(sev) || sev < 1 || sev > 10) {
      return setMsg("Severity must be 1–10.");
    }
      ...
      <form onSubmit={submit} style={{ display: "grid", gap: 12 }}>
        ...
        <label>
          ...
          <input
            ...
            placeholder="stress, lack of sleep"
          />
        </label>
        ...
        <label>
          ...
          <input
            ...
            placeholder="aura, nausea, photophobia"
          />
        </label>
        ...
        <label>
          ...
          <input
            ...
            placeholder="sumatriptan, caffeine"
          />
        </label>
        ...
        <div
          style={{
            minHeight: 20,
            color: msg.startsWith("Saved") ? "green" : "crimson",
          }}
        >
          {msg}
        </div>
